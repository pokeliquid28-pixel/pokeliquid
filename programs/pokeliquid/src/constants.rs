...
pub const DEFAULT_INSURANCE_FUND_BPS: u64 = 1_000;
...
pub const DEFAULT_LP_FEE_BPS: u64 = 3_000; // 30% of trading fees go to LPs
...
pub const LIQUIDATION_INSURANCE_BPS: u64 = 900; // 9%
// 90% stays in fee_vault
