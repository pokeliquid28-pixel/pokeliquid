    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#0a0a0a", fontFamily: "'JetBrains Mono', 'Fira Mono', 'Consolas', monospace", color: "#fff" }}>
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 16px" }}>
        ...
        <Section title="What is DR-INDEX?">
          ...
          <P>Rather than trading individual cards, DR-INDEX gives you exposure to the entire Destined Rivals set in a single tradeable perpetual market on Pokeliquid. When the set&apos;s value goes up, DR-INDEX goes up. When it goes down, DR-INDEX goes down.</P>
        </Section>
