  ...
  const spin = useCallback(async () => {
    ...
    try {
      const res = await fetch(`${API_BASE}/spin`, {
        ...
        body: JSON.stringify({ user: publicKey.toBase58(), wheel: "free", tx_signature: null }),
      });
      ...
      // Wait for shake animation to finish (0.5s × 3 = 1.5s)
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-secondary">
              Trade $100+. Spin once daily. Win a real graded Pokémon card.
            </p>
