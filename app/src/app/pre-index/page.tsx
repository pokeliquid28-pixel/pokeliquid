...
import cardsData from "@/data/pre-cards.json";
...
export default function PREIndexPage() {
    ...
    >
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 16px" }}>
        ...
        >
          ...
          >
            Scarlet &amp; Violet &middot; Prismatic Evolutions &middot; All {TOTAL_CARDS} Cards
          </p>
        </div>

        {/* ── What is PRE-INDEX? ─────────────────────────────── */}
        <Section title="What is PRE-INDEX?">
          <P>
          ...
          <P>
            ...
            entire Prismatic Evolutions set in a single tradeable perpetual market on
            Pokeliquid. When the set&apos;s value goes up, PRE-INDEX goes up.
            When it goes down, PRE-INDEX goes down.
          </P>
        </Section>
        ...
        <Section title="Methodology">
          <BulletList
            items={[
              `Complete basket of all ${TOTAL_CARDS} cards in the Prismatic Evolutions set`,
