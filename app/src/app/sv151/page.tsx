...
import cardsData from "@/data/sv151-cards.json";
...
export default function SV151Page() {
    ...
    >
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 16px" }}>
        ...
        >
          ...
          >
            Scarlet &amp; Violet 151 &middot; All 215 Cards
          </p>
        </div>

        {/* ── What is SV151? ─────────────────────────────────── */}
        <Section title="What is SV151?">
          <P>
            The SV151 index tracks the combined market value of all 215 cards in
            the Scarlet &amp; Violet 151 set on TCGPlayer &mdash; the largest
            Pokemon card marketplace.
          </P>
          <P>
            Rather than trading individual cards, the SV151 gives you exposure to
            the entire SV 151 set in a single tradeable perpetual market on
            Pokeliquid. When the set&apos;s value goes up, the SV151 goes up.
            When it goes down, the SV151 goes down.
          </P>
        </Section>
        ...
        <Section title="Methodology">
          <BulletList
            items={[
              "Complete basket of all 215 cards in the Scarlet & Violet 151 set",
              "Index value = sum of all 215 individual card market prices",
              "Prices fetched from TCGPlayer's market price API every 60 seconds",
              "No rebalancing needed — the set is fixed at 215 cards",
            ]}
          />
        </Section>
        ...
        <Section title="Index Statistics">
          ...
          >
            ...
            <StatBox label="Cards in Index" value="215" />
            <StatBox
        ...
        <Section title="All 215 Cards">
          ...
          <div style={{ fontSize: 11, color: "#666", marginBottom: 12 }}>
            Showing {filteredCards.length} of 215 cards
          </div>
