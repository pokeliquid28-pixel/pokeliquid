...
import cardsData from "@/data/ah-cards.json";
...
export default function AHIndexPage() {
    ...
    >
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 16px" }}>
        ...
        >
          ...
          >
            Mega Evolution: Ascended Heroes &middot; All 580 Cards
          </p>
        </div>

        {/* ── What is AH-INDEX? ─────────────────────────────────── */}
        <Section title="What is AH-INDEX?">
          <P>
          ...
          <P>
            ...
            the entire Ascended Heroes set in a single tradeable perpetual market on
            Pokeliquid. When the set&apos;s value goes up, the AH-INDEX goes up.
            When it goes down, the AH-INDEX goes down.
          </P>
        </Section>
        ...
        <Section title="Methodology">
          <BulletList
            items={[
              "Complete basket of all 580 cards in the Ascended Heroes set",
              "Index value = sum of all 580 individual card market prices",
              "Prices fetched from TCGPlayer's market price API every 60 seconds",
              "No rebalancing needed — the set is fixed at 580 cards",
            ]}
          />
        </Section>
        ...
        <Section title="All 580 Cards">
          ...
          <div style={{ fontSize: 11, color: "#666", marginBottom: 12 }}>
            Showing {filteredCards.length} of 580 cards
          </div>
